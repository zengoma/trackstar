...
class m130930_105033_create_rbac_tables extends CDbMigration
{
	public function up()
	{
...
$this->createTable('tbl_auth_item_child',
        array( 'parent' =>'varchar(64) NOT NULL',
...
$this->createTable('tbl_auth_assignment',
        array( 'itemname' =>'varchar(64) NOT NULL',
